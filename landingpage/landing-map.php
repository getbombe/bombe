...
<body>
	...
	<header id="head">
		...
		<div class="inner">
			<a href="#" class="logotext square"><h1>My Startup</h1></a>
			<div class="details right">
				...
				<div class="message">
					...
					<p class="small">Morbi non massa arcu, sed molestie arcu tellus vitae vestibulum. Libero lacus semper massa at sollicitudin dolor magna nulla velit. Aenean tempor pellentesque enim vel rhoncus. Suspendisse lacinia blandit tincidunt.</p>
				</div>
		...
		<div class="contact_map" id="contact">
			<div id="canvas_holder" style="height:100%;width:100%">
